...
public interface FileConverter {
    ...
    /**
     * FileChunkMergePO转化FileChunkMergeContext
     *
     * @param fileChunkMergePO
     * @return
     */
    @Mapping(target = "userId", expression = "java(com.heyqing.disk.server.common.utils.UserIdUtil.get())")
    @Mapping(target = "parentId", expression = "java(com.heyqing.disk.core.utils.IdUtil.decrypt(fileChunkMergePO.getParentId()))")
    FileChunkMergeContext fileChunkMergePO2FileChunkMergeContext(FileChunkMergePO fileChunkMergePO);

    /**
     * FileChunkMergeContext转化FileChunkMergeAndSaveContext
     *
     * @param context
     * @return
     */
